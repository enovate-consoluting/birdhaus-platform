...
WHERE `label_password_detail`.`label_pass_detail_id` = <cfqueryparam cfsqltype="cf_sql_numeric" value="#URL.label_pass_detail_id#">
</cfquery>
										...
										<div class="row">
											<div class="col-md-12">
												...
												<div class="form-group row">                                                    
													...
													<div class="col-sm-9">
														<cftextarea name="verify_once_message" id="verify_once_message" maxlength="400" richtext="no" style="width:100%; height:80px;"><cfoutput>#getLabelPassDetail.verify_once_msg#</cfoutput></cftextarea>
													</div>							
                                                </div>
												<div class="form-group row">                                                    
													<label for="label_validation_msg" class="col-sm-3 control-label col-form-label">Label Validation Message</label>
													<div class="col-sm-9">
														<cftextarea name="label_validation_msg" id="label_validation_msg" maxlength="400" richtext="no" style="width:100%; height:80px;"><cfoutput>#getLabelPassDetail.label_validation_msg#</cfoutput></cftextarea>
													</div>							
                                                </div>	
												<div class="form-group row">                                                    
