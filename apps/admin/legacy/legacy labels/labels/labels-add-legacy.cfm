            ...
            <div class="page-breadcrumb bg-white">
                <div class="row">
                    <div class="col-lg-3 col-md-4 col-xs-12 align-self-center">
                        <h5 class="font-medium text-uppercase mb-0">Add Labels</h5>
                    </div>
            ...
            <div class="page-content container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <cfform action="labels-add-save-legacy.cfm" enctype="multipart/form-data" method="post" onsubmit="return validateForm()">
                                    <div class="form-body">
                                        ...
                                        <div class="row">											
                                            ...
                                            <div class="col-md-5">
                                                <div class="form-group">
                                                    ...
                                                    <cfinput type="text" name="range_start" id="range_start" class="form-control" placeholder="Numeric Values Only" required="yes" message="Please enter a numeric value for Range Start field">
												</div>
                                            </div>
                                            <div class="col-md-5">
                                                <div class="form-group">
                                                    <label class="control-label">Range End</label>
                                                    <cfinput type="text" name="range_end" id="range_end" class="form-control" placeholder="Numeric Values Only" required="yes" message="Please enter a numeric value for Range End field">
												</div>
                                            </div>		
                                            <div class="col-md-12">
                                                <div class="form-group">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12" style="padding-bottom:15px;">
                                                <h5 class="card-title mt-3">Document</h5>
												<hr>
												<input name="doc" id="doc" type="file" accept="application/pdf" />												
                                            </div>
                                        </div>																													
                                        <hr> 										
										<div class="row">
											...
											<h5 class="card-title">Options</h5>
												...
												<div class="form-group row">                                                    
													...
													<div class="col-sm-9">
														<cftextarea name="verify_once_message" id="verify_once_message" maxlength="400" richtext="no" style="width:100%; height:80px;"><cfoutput>#application.verifyOnceMessageDefault#</cfoutput></cftextarea>
													</div>							
                                                </div>
												<div class="form-group row">                                                    
													<label for="label_validation_msg" class="col-sm-3 control-label col-form-label">Label Validation Message</label>
													<div class="col-sm-9">
														<cftextarea name="label_validation_msg" id="label_validation_msg" maxlength="400" richtext="no" style="width:100%; height:80px;"></cftextarea>
													</div>							
                                                </div>	
												<div class="form-group row">                                                    
