/**
 * Admin Login Page
 * Authenticates against Factory Supabase users
...
import { setSession, isSessionValid } from '@/lib/auth';
...
function LoginContent() {
  ...
  const handleAuth = async (e: React.FormEvent) => {
    ...
    try {
      // Call login API (validates against Factory Supabase)
    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-xl shadow-lg w-full max-w-md p-8">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">Admin Platform</p>
        </div>
        ...
        <div className="mt-6 pt-6 border-t border-gray-200">
          <p className="text-xs text-gray-500 text-center">
            Use your Factory Orders credentials to sign in.
          </p>
        </div>
      </div>
    </div>
